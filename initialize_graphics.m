...
function [mainAxis, ship, ship2, axisTitle, heroPos, villainPos,fig,torpedo_1,torpedo_2] = initialize_graphics()
...
set(torpedo_1, 'Marker', 'd', ... % Hero torpedo shape
    'MarkerFaceColor', [0 0 1], ... % Hero torpedo color (previously [0.1 0.7 0.5])
    'MarkerEdgeColor', [0 0 1], ... % Hero torpedo edge color
    'MarkerSize', 5);... % Hero torpedo size

% Villain torpedos
torpedo_2 = plot(NaN,NaN);
set(torpedo_2, 'Marker', 'd', ... % Villain torpedo shape
    'MarkerFaceColor', [1 0 0], ... % Villain torpedo color (previously [0.1 0.7 0.5])
    'MarkerEdgeColor', [1 0 0], ... % Villain torpedo edge color
    'MarkerSize', 5);... % Villain torpedo size
